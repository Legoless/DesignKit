...
- (void)setDrawingBlock:(DKDrawingBlock)drawingBlock forTag:(DKDrawingTag *)tag forState:(UIControlState)state
{
...
- (DKDrawingBlock)drawingBlockForTag:(DKDrawingTag *)tag forState:(UIControlState)state
{
    NSString* controlState = [NSString stringWithFormat:@"%d", state];
...
- (BOOL)containsDrawingBlockForTag:(DKDrawingTag *)tag
{
    if (self.drawingBlocks[tag])
    {
        return YES;
...
- (BOOL)containsDrawingBlockForTag:(DKDrawingTag *)tag forState:(UIControlState)state
{
    NSString* controlState = [NSString stringWithFormat:@"%d", state];

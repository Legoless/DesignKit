...
/*!
 * Returns drawing block for tag (normal state)
 */
- (DKDrawingBlock)drawingBlockForTag:(DKDrawingSourceTag *)tag;
...
/*!
 * Sets drawing block for normal state
 */
- (void)setDrawingBlock:(DKDrawingBlock)drawingBlock forTag:(DKDrawingSourceTag *)tag;
